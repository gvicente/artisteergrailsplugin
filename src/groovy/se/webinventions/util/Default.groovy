        ...
        <div class="art-footer-wrapper">
            <div class="art-footer-text">
                ...
                <center>
                    ...
                    <p><a href="#"><img width="32" height="32" alt=""
                                        src="\${resource(dir: 'images', file: 'footer/rss_32.png')}"
                                        style="margin-right: 10px;"/></a><a href="#"><img width="32" height="32"
                                                                                          alt=""
                                                                                          src="\${resource(dir: 'images', file: 'footer/facebook_32.png')}"
                                                                                          style="margin-right: 10px;"/>
                    </a><a href="#"><img width="32" height="32" alt=""
                                         src="\${resource(dir: 'images', file: 'footer/twitter_32.png')}"
                                         style="margin-right: 10px;"/></a></p>

                    <p><br/><br/><br/><a href="#"></a>Copyright © 2011 All Rights Reserved.</p>

                    <p style="font-size: 10px">Artisteer Plugin c/o <a href="">WebInventions</a></p>
...
<artisteer:applyArtisteerLayout>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="\${resource(dir: 'css', file:'footer/footer.css')}" />
