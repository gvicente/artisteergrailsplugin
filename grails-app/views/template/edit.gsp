            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: templateInstance, field: 'name', 'errors')}">
                        <g:textField name="name" readonly="readonly" value="${templateInstance?.name}"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="category"><g:message code="template.category.label" default="Category"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: templateInstance, field: 'category', 'errors')}">
                        <g:textField name="category" value="${templateInstance?.category}"/>
                    </td>
                </tr>
